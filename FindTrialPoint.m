...
function [TrialPoint] = FindTrialPoint(iter,baseODMatrix,HOMEDIRECTORY,Betas,Evaluated_Points,NUM_VEHICLES_TO_REMOVE,TopODIndices,AllowedReductionPercentage)
