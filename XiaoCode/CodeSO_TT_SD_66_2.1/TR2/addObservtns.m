function currAvg = addObservtns(readF,pointID,add2file,runAimsun,currReplicID)
...
if isnumeric(readF) % the fSim value has been passed directly and not through a file name
    ...
    if runAimsun ~= 0
        ...
        currFile = 'C:\MIT\Lab\KanchanaNanduri\CodeSO_TT_FC\Runs1\PyOutputs\TTPerReplic_dummy.txt';
    end;
