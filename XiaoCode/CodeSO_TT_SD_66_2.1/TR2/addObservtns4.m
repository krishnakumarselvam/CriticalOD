function currAvg = addObservtns4(readF,pointID,add2file,runAimsun,currReplicID)
...
if isnumeric(readF) % the fSim value has been passed directly and not through a file name
    ...
    if runAimsun ~= 0
        ...
        currFile = 'C:\MIT\Lab\KanchanaNanduri\CodeSO_TT_FC\Runs4\PyOutputs\TTPerReplic_dummy.txt';
    end;
